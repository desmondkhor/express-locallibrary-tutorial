...
exports.bookinstance_list = function(req, res, next) {
    ...
    // .sort({book: 'asc', title: 'asc'})
    .exec(function (err, list_bookinstances) {
        if (err) { return next(err); }
        // console.log(list_bookinstances);
        // Successful, so render
        res.render('allbookinstance_list', { title: 'All Book Instance List', bookinstance_list: list_bookinstances });
    });
};

// Display list of all BookInstances.
exports.allbookinstance_list = function(req, res, next) {
...
exports.bookinstance_update_post = [
    ...
    sanitizeBody('book').escape(),
    sanitizeBody('imprint').escape(),
    sanitizeBody('due_backummary').escape(),
